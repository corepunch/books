> Historical visual validation of unchanged image contents. Paths and camera
> names below predate the engine migration; current shots use `room-look` and
> `room-examine-object` in `books/wondertown/rooms/`.
