...
Historical layout study: the referenced workshop source now lives in
`archive/rooms/workshop.blks`. Legacy Lua measurement commands below are retired;
use [RENDERING.md](RENDERING.md) for the active workflow.
